...
TOKEN = '8243502695:AAGFdqq18-kCXRNbxb7b9jRSxsu6PqQKnRw'
...
def get_numbers_keyboard():
    ...
    keyboard = InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="🎲 Тык ❤️", callback_data="generate_numbers")]
        ]
    )
    return keyboard
...
async def cmd_start(message: types.Message):
    await message.answer(
        "Вы готовы?✨✨\n\n"
        "Скорее узнай свои арканы, тыкни 👇",
